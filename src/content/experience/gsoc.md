...
tags: ["C++", "ArduPilot", "MAVLink"]
order: 1
---

## Role

I am developing AP_SwarmMesh, a C++ ArduPilot communication middleware library for decentralized MAVLink peer-state exchange over a dedicated peer-to-peer serial interface.
